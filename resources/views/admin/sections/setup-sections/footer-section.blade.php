                ...
                <div class="row justify-content-center mb-10-none">
                    ...
                    <div class="border-bottom my-3"></div>
                        <div class="col-xl-12 col-lg-12 form-group">
                            <div class="custom-inner-card input-field-generator" data-source="setup_section_footer_communication_link_input">
                                <div class="card-inner-header">
                                    <h6 class="title">{{ __("Communication") }}</h6>
                                    <button type="button" class="btn--base add-row-btn"><i class="fas fa-plus"></i> {{ __("Add") }}</button>
                                </div>
                                <div class="card-inner-body">
                                    <div class="results">
                                        @php
                                            $communication_links = $data->value->communication_links ?? [];
                                        @endphp
                                        @forelse ($communication_links as $item)
                                            <div class="row align-items-end">
                                                <div class="col-xl-3 col-lg-3 form-group">
                                                    @include('admin.components.form.input',[
                                                        'label'         => __("Communication Icon")."*",
                                                        'name'          => "communication_icon[]",
                                                        'placeholder'   => __("Communication Icon")."...",
                                                        'class'         => "form--control icp icp-auto iconpicker-element iconpicker-input",
                                                        'value'         => $item->communication_icon ?? "",
                                                    ])
                                                </div>
