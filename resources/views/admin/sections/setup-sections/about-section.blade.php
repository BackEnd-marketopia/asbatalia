                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                'name'      => $lang_code . "_statistic_first_title",
                                                'value'     => old($lang_code . "_statistic_first_title",$data->value->language->$lang_code->statistic_first_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Counter Title Value")." "."1*",
                                                'type'      => "number",
                                                'name'      => $lang_code . "_statistic_first_value",
                                                'value'     => old($lang_code . "_statistic_first_value",$data->value->language->$lang_code->statistic_first_value ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Counter Title")." "."2*",
                                                'name'      => $lang_code . "_statistic_second_title",
                                                'value'     => old($lang_code . "_statistic_second_title",$data->value->language->$lang_code->statistic_second_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Counter Title Value")." "."2*",
                                                'type'      => "number",
                                                'name'      => $lang_code . "_statistic_second_value",
                                                'value'     => old($lang_code . "_statistic_second_value",$data->value->language->$lang_code->statistic_second_value ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Counter Title")." "."3*",
                                                'name'      => $lang_code . "_statistic_last_title",
                                                'value'     => old($lang_code . "_statistic_last_title",$data->value->language->$lang_code->statistic_last_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Counter Title Value")." "."3*",
                                                'type'      => "number",
                                                'name'      => $lang_code . "_statistic_last_value",
                                                'value'     => old($lang_code . "_statistic_last_value",$data->value->language->$lang_code->statistic_last_value ?? "")
                                            ])
                                        </div>
                                    </div>
                                @endforeach
