                                                                ...
                                                                <div class="content pt-0">
                                                                    <div class="list-wrapper">
                                                                        <ul class="list" style="width: 100%;">
                                                                            <li style="margin-left: 0 !important;">Doctor Name:<span style="float: right !important;">{{ $data['doctor_name']}}</span></li>
                                                                            <li style="margin-left: 0 !important;">Speciality:<span style="float: right !important;">{{ $data['doctor_speciality']}}</span></li>
                                                                            <li style="margin-left: 0 !important;">Schedule:<span style="float: right !important;">{{ $data['schedule']}} ({{ $data['from_time'] }} - {{ $data['to_time'] }})</span></li>
                                                                            ...
                                                                            <li style="margin-left: 0 !important;">Serial Number:<span style="float: right !important;">{{ $data['serial_number']}}</span></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
