...
`,
setup_section_footer_communication_link_input:`
<div class="row align-items-end">
  <div class="col-xl-3 col-lg-3 form-group">
      <label>Communication Icon*</label>
      <input type="text" class="form--control icp icp-auto iconpicker-element iconpicker-input" placeholder="Type Here..." name="communication_icon[]">
  </div>
  <div class="col-xl-8 col-lg-8 form-group">
      <label>Contact Info*</label>
      <input type="text" class="form--control" placeholder="Type Here..." name="communication_link[]">
  </div>
  <div class="col-xl-1 col-lg-1 form-group">
      <button type="button" class="custom-btn btn--base btn--danger row-cross-btn w-100"><i class="las la-times"></i></button>
  </div>
